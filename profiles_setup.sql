...
ON CONFLICT (id) DO NOTHING;
-- ── terms_accepted_at column (added Feb 2025) ─────────────────────────────
-- Stores when user accepted T&C/Privacy Policy. Used to skip the acceptance
-- gate on subsequent logins and across devices.
DO $$
BEGIN
