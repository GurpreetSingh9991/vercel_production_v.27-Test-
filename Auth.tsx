    ...
    <div className="space-y-8 pb-12 animate-in fade-in duration-700">
      ...
      <div className="bg-white/80 backdrop-blur-3xl rounded-2xl border border-white/40 shadow-2xl overflow-hidden min-h-[500px] flex flex-col relative">
        ...
        {isLoadingCache && (() => {
          ...
          const isWeekendAI = day === 5 || day === 6; // Fri or Sat
          return (
            <div className="flex-1 flex flex-col items-center justify-center gap-4 p-8">
              ...
              {isWeekendAI && (
                <div className="max-w-xs text-center animate-in fade-in duration-700">
                  <p className="text-[10px] font-black uppercase tracking-widest text-amber-600 mb-2">⏳ Processing in Progress</p>
                  <p className="text-xs text-black/50 leading-relaxed">
                    Your weekly AI insights are being compiled. Insights will be ready on <strong>Sunday</strong> after full market wrap-up.
                  </p>
                </div>
              )}
            </div>
